...
import { MdPlace, MdDateRange, MdPeople, MdTimer } from "react-icons/md"
  ...
  return (
    <Fragment>
      <Form id="bookingBus" className="d-block" ref={ref}>
        ...
        <Form.Row>
          <Form.Group controlId="arrival" className="position-relative col-6">
            {/* <Form.Label className="">{lang[language].arrival.label}</Form.Label> */}
            <Form.Control type="text" placeholder={"Часы"} />
            <span className="icon-inside">
              <MdTimer />
            </span>
          </Form.Group>
          <Form.Group controlId="arrival" className="position-relative col-6 ">
            {/* <Form.Label className="">{lang[language].arrival.label}</Form.Label> */}
            <Form.Control type="text" placeholder={"Минуты"} />
            <span className="icon-inside">
              <MdTimer />
            </span>
          </Form.Group>
        ...
        <Form.Row>
          <Form.Group controlId="arrival" className="position-relative col-6">
            {/* <Form.Label className="">{lang[language].arrival.label}</Form.Label> */}
            <Form.Control disabled type="text" placeholder={"Часы"} />
            <span className="icon-inside">
              <MdTimer />
            </span>
          </Form.Group>
          <Form.Group controlId="arrival" className="position-relative col-6 ">
            {/* <Form.Label className="">{lang[language].arrival.label}</Form.Label> */}
            <Form.Control disabled type="text" placeholder={"Минуты"} />
            <span className="icon-inside">
              <MdTimer />
            </span>
          </Form.Group>
