  ...
  [9],
  {
    ...
    GddB: function (t, e, n) {
          ...
          c.a.Provider,
          {
            value: Object.assign({}, r, {
              ...
              onAddBasketItem: function (t) {
                return function (e) {
                  ...
                  if (c[t].length < u)
                    ...
                    var s = c[t].filter(function (t) {
                      return t.ticket_id != i;
                    });
                    if (((c[t] = []), s.length > u)) c[t] = [];
                    else {
                      var l = 0;
                  ...
                  a({ type: "ADD_BASKET_ITEM", payload: c });
                };
              },
              ...
              onBasketCommit: function (t) {
                return function (e) {
                  ...
                  u[t].forEach(function (t) {
                    ...
                    a({ type: "BASKET_COMMIT", payload: u }),
                    a({ type: "SHOW_PLACEMENT_DIALOG", payload: !1 });
                };
              },
              onToggleAlert: l,
              onShowPaymentSytemDialog: h,
              ...
              onClearBasket: function () {
                a({ type: "", payload: [] }), Object(f.navigate)("/offers");
              },
              onBooking: v,
      ...
      var m =
          ...
          r),
        g = Object(o.createContext)({ data: "hello" });
      function y(t) {
        var e = t.element;
        return i.a.createElement(
          g.Provider,
        ...
        return (
          ...
          [
            ...
            function (t, e) {
              ...
              for (var w = 0, _ = 0, E = []; _ < p.length; ) {
                y.lastIndex = h ? _ : 0;
                var x,
                  S = c(y, h ? p : p.slice(_));
                if (
                  null === S ||
                  (x = f(u(y.lastIndex + (h ? 0 : _)), p.length)) === w
                )
                  _ = a(p, _, m);
                else {
                  if ((E.push(p.slice(w, _)), E.length === b)) return E;
          ...
          return O(o).then(function (n) {
            ...
            if (200 === o)
              try {
                ...
                return Object.assign(t, { status: E.Success, payload: a });
              } catch (u) {}
            return 404 === o || 200 === o
              ? "/404.html" === e
                ? Object.assign(t, { status: E.Error })
        ...
        j = (function () {
          ...
          return (
            ...
            (e.getResourceURLsForPathname = function (t) {
              ...
              if (n) {
                var r = R(n.payload);
                return [].concat(b(A(r.page.componentChunkName)), [S(e)]);
              }
              return null;
            }),
          ...
          return (
            (o.doPrefetch = function (t) {
              ...
              return i(n, { crossOrigin: "anonymous", as: "fetch" })
                ...
                .then(function (t) {
                  if (t.status !== E.Success) return Promise.resolve();
                  var e = t.payload,
                ...
                .then(function (t) {
                  return t.notFound
                    ? O(e, "HEAD").then(function (e) {
                        return 200 === e.status ? { status: E.Error } : t;
                      })
                    : t;
                });
            }),
    ...
    ioFf: function (t, e, n) {
      ...
      var r = n("dyZX"),
        ...
        Q = function (t, e) {
          if (((t = _(t)), (e = E(e, !0)), t !== G || !o(N, e) || o(K, e))) {
            var n = T(t, e);
            return (
              !n || !o(N, e) || (o(t, F) && t[F][e]) || (n.enumerable = !0), n
            );
          }
        },
        $ = function (t) {
          for (var e, n = L(_(t)), r = [], i = 0; n.length > i; )
            o(N, (e = n[i++])) || e == F || e == c || r.push(e);
          return r;
        },
        tt = function (t) {
          for (
            var e, n = t === G, r = L(n ? K : _(t)), i = [], a = 0;
            r.length > a;

          )
            !o(N, (e = r[a++])) || (n && !o(G, e)) || i.push(N[e]);
          return i;
        };
      W ||
        (u(
          (I = function () {
            ...
            return i && X && Y(G, t, { configurable: !0, set: e }), B(t);
          }).prototype,
          "toString",
          function () {
            return this._k;
        ...
        (n("UqcF").f = z),
        (R.f = tt),
        i && !n("LQAc") && u(G, "propertyIsEnumerable", z, !0),
        (h.f = function (t) {
          return B(d(t));
        })),
        ...
        return [
          ...
          function (t, e) {
            ...
            for (var w, _ = "", E = 0, x = 0; x < y.length; x++) {
              ...
              var j = b.groups;
              if (d) {
                var A = [S].concat(P, O, p);
                void 0 !== j && A.push(j);
                var T = String(e.apply(void 0, A));
              } else T = v(S, p, O, P, j, e);
              O >= E && ((_ += p.slice(E, O) + T), (E = O + S.length));
            }
            return _ + p.slice(E);
          },
        ];
...
//# sourceMappingURL=app-0e10947f15385997aa13.js.map
