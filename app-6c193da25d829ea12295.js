  ...
  [12],
  {
    "+ZDr": function (t, e, n) {
      ...
      var _ = function (t, e, n) {
        ...
        E = s.default.forwardRef(function (t, e) {
      ...
      e.navigateTo = function (t) {
        return _("navigateTo", "navigate", 3), b(t);
      };
    },
    "+lvF": function (t, e, n) {
        ...
        if (
          ...
          P ||
            (((_ = e(function (e, n) {
              s(e, _, t);
              var r = h(new y(), e, _);
              return null != n && u(n, v, r[E], r), r;
            })).prototype = b),
            (b.constructor = _)),
            (T || R) && (O("delete"), O("has"), v && O("get")),
            (R || x) && O(E),
            g && b.clear && delete b.clear;
        } else
          (_ = m.getConstructor(e, t, v, E)), a(_.prototype, n), (c.NEED = !0);
        return (
          d(_, t),
          (S[t] = _),
          o(o.G + o.W + o.F * (_ != y), S),
    ...
    Afnz: function (t, e, n) {
      ...
      t.exports = function (t, e, n, h, m, v, g) {
        ...
        var y,
          ...
          P = T || b(m),
          R = m ? (O ? b("entries") : P) : void 0,
          A = ("Array" == e && x.entries) || T;
        if (
          (A &&
            (E = l(A.call(new t()))) !== Object.prototype &&
            E.next &&
            (s(E, S, !0), r || "function" == typeof E[f] || a(E, f, d)),
          O &&
            T &&
            "values" !== T.name &&
            ((w = !0),
        ...
        return function (e, c, h) {
          for (
            var m,
              ...
              E = a(y.length),
              b = 0,
              S = n ? d(e, E) : u ? d(e, 0) : void 0;
            E > b;
            b++
          )
            if ((p || b in y) && ((v = _((m = y[b]), b, g)), t))
              if (n) S[b] = v;
              else if (v)
                switch (t) {
                  case 3:
    ...
    GddB: function (t, e, n) {
          ...
          switch (r) {
            ...
            case "OPEN_AUTH_DIALOG":
              return Object.assign({}, t, {
                OPEN_AUTH_DIALOG: !t.OPEN_AUTH_DIALOG,
              });
            case "SHOW_MOBILE_NAV":
              return Object.assign({}, t, {
                SHOW_MOBILE_NAV: !t.SHOW_MOBILE_NAV,
              });
            case "SHOW_MOBILE_BASKET_IN_OFFERS":
              return Object.assign({}, t, {
                SHOW_MOBILE_BASKET_IN_OFFERS: !t.SHOW_MOBILE_BASKET_IN_OFFERS,
              });
            case "SHOW_MOBILE_FILTER_IN_OFFERS":
              return Object.assign({}, t, {
                SHOW_MOBILE_FILTER_IN_OFFERS: !t.SHOW_MOBILE_FILTER_IN_OFFERS,
              });
            case "SHOW_MOBILE_BASKET_DETAIL":
              return Object.assign({}, t, {
                SHOW_MOBILE_BASKET_DETAIL: !t.SHOW_MOBILE_BASKET_DETAIL,
              });
            case "SHOW_MOBILE_BASKET_BOOKING":
              return Object.assign({}, t, {
                SHOW_MOBILE_BASKET_BOOKING: !t.SHOW_MOBILE_BASKET_BOOKING,
              });
            case "SHOW_MOBILE_PERSONAL_MENU":
              return Object.assign({}, t, {
                SHOW_MOBILE_PERSONAL_MENU: !t.SHOW_MOBILE_PERSONAL_MENU,
              });
            ...
            case "SHOW_PLACEMENT_DIALOG":
              return Object.assign({}, t, {
                SHOW_PLACEMENT_DIALOG: !t.SHOW_PLACEMENT_DIALOG,
            ...
            case "SHOW_PAYMENT_SYTEM_DIALOG":
              return Object.assign({}, t, {
                SHOW_PAYMENT_SYTEM_DIALOG: !t.SHOW_PAYMENT_SYTEM_DIALOG,
              });
          ...
          l = function (t) {
            return function (e) {
              ...
              n.forEach(function (r, o) {
                ...
                a({ type: "TOGGLE_ALERT", payload: n });
            };
          },
          f = function () {
            a({ type: "SHOW_PAYMENT_SYTEM_DIALOG", payload: null });
          },
          v = (function () {
            var t,
              e =
            ...
            u.a.Provider,
            {
              value: Object.assign({}, r, {
                onSetAuth: function (t) {
                  t.preventDefault(),
                    a({ type: "IS_AUTH", payload: !0 }),
                    alert("Вы авторизованы");
                },
                onOpenAuthDialog: function () {
                  a({ type: "OPEN_AUTH_DIALOG", payload: null });
                },
                onToggleMobileNav: function () {
                  a({ type: "SHOW_MOBILE_NAV", payload: null });
                },
                onShowMoreRoutes: function (t) {
                  ...
                  a({ type: "SHOW_MORE_ROUTES", payload: o > i ? i : o });
                },
                onOpenPlacementDialog: function (t) {
                  a({ type: "SHOW_PLACEMENT_DIALOG", payload: t });
                },
                onAddBasketItem: function (t) {
                  return function (e) {
                    ...
                    a({ type: "ADD_BASKET_ITEM", payload: u });
                  };
                },
                onRemoveBaksetItem: function (t) {
                  return function (e) {
                    ...
                    (o[t] = o[t].filter(function (t) {
                      ...
                      a({ type: "REMOVE_BASKET_ITEM", payload: o });
                  };
                },
                onBasketCommit: function (t) {
                  return function (t) {
                    var e = r.BASKET,
                      n =
                        (r.OFFERS,
                        r.SELECTED_OFFERS_ID,
                        r.SELECTED_DIRECTION,
                        Object(d.cloneDeep)(e));
                    a({ type: "BASKET_COMMIT", payload: n }),
                      a({ type: "SHOW_PLACEMENT_DIALOG", payload: !1 });
                  };
                },
                onBasketOffersCommit: function (t) {
                  return function (e) {
                    var n = r.BASKET,
                      o = r.OFFERS,
                      i = r.SELECTED_OFFERS_ID,
                      c = Object(d.cloneDeep)(n);
                    c[t].forEach(function (t) {
                      0 == t.status && ((t.status = 1), (t.offers = o[i - 1]));
                    }),
                      a({ type: "BASKET_OFFERS_COMMIT", payload: c }),
                      a({ type: "SHOW_PLACEMENT_DIALOG", payload: !1 });
                  };
                },
                onToggleAlert: l,
                onShowPaymentSytemDialog: f,
                onSelectPaymentSystem: function (t) {
                  ...
                  e.forEach(function (n, r) {
                    ...
                    a({ type: "SELECT_PAYMENT_SYSTEM", payload: e });
                },
                onClearBasket: function () {
                  a({ type: "CLEAR_BASKET", payload: { 1: [], 0: [] } }),
                ...
                onToggleAgreementDialog: function (t) {
                  return function () {
                    ...
                    (e[t] = !e[t]),
                      a({ type: "TOGGLE_AGREEMENT_DIALOGS", payload: e });
                  };
                },
                onSelectPassengerId: function (t) {
                  a({ type: "SELECTED_BASKET_PASSENGER_ID", payload: t });
                },
                onRemovePassengerFromBasket: function () {
                  ...
                  a({ type: "REMOVE_PASSENGER_FROM_BASKET", payload: t }),
                    a({ type: "SELECTED_BASKET_PASSENGER_ID", payload: null });
                },
                onSelectDirectionFromBasket: function (t) {
                  a({ type: "SELECT_DIRECTION", payload: t });
                },
                onRemoveDirectionFromBasket: function () {
                  var t = r.BASKET_COMMIT;
                  (t[r.SELECTED_DIRECTION] = []),
                    a({ type: "REMOVE_DIRECTION_FROM_BASKET", payload: t }),
                    a({ type: "SELECT_DIRECTION", payload: null });
                },
                onSavePrevBasket: function () {
                  var t = Object(d.cloneDeep)(r.BASKET_COMMIT);
                  a({ type: "SAVE_PREV_BASKET", payload: t });
                },
                  ...
                  return (
                    ...
                    function (e) {
                      ...
                      var n = r.SELECTED_PASSENGER_ID,
                        o = Object(d.cloneDeep)(r.BASKET);
                      o[t].forEach(function (r, i) {
                        r.passenger_id == n && (o[t][i].place = e);
                      }),
                        a({ type: "CHANGE_PLACEMENT", payload: o });
                    }
                  );
                },
                onChangePlacementCommit: function () {
                  var t = Object(d.cloneDeep)(r.BASKET);
                  a({ type: "COMMIT_CHANGE_PLACEMET", payload: t });
                },
                onShowMobileBasketInOffers: function () {
                  a({ type: "SHOW_MOBILE_BASKET_IN_OFFERS" });
                },
                onShowMobileFilterInOffers: function () {
                  a({ type: "SHOW_MOBILE_FILTER_IN_OFFERS" });
                },
                onShowMobileBasketBooking: function () {
                  a({ type: "SHOW_MOBILE_BASKET_BOOKING" });
                },
                onShowMobileBasketDetail: function () {
                  a({ type: "SHOW_MOBILE_BASKET_DETAIL" });
                },
                onShowMobilePersonalMenu: function () {
                  a({ type: "SHOW_MOBILE_PERSONAL_MENU" });
                },
                lang: "ru",
              }),
            },
      ...
      var y =
          (((r = {}).IS_AUTH = !1),
          (r.OPEN_AUTH_DIALOG = !1),
          (r.SHOW_MOBILE_NAV = !1),
          (r.SHOW_PLACEMENT_DIALOG = !1),
          (r.MAIN_SLIDER_SLIDS = l.main_slider),
          (r.OFFERS = l.offers),
          (r.ROUTES = {
            data: l.routes,
            nowShowRoutes: 6,
            allCountRoutes: l.routes.length,
          }),
          (r.ROUTE_DETAIL = l.route_detail),
          (r.ROUTE_SERVISES = l.route_servises),
          (r.MAIN_WHY_WE_ARE = l.main_why_we_are),
          (r.MAIN_QUESTION_ANSWER = l.main_question_answer),
          (r.MAIN_NEWS = l.news),
          (r.SERVISES = l.servises),
          (r.SOCIAL = l.social),
          (r.PAYMENT = l.payment),
          (r.CONTACT = l.contact),
          (r.TOP_NAVS = l.main_navs_list),
          (r.BUS = l.busPlacement),
          (r.BASKET = { 0: [], 1: [] }),
          (r.BASKET_COMMIT = { 0: [], 1: [] }),
          (r.SELECTED_OFFERS_ID = 0),
          (r.ALERT = l.alert),
          (r.SHOW_PAYMENT_SYTEM_DIALOG = !1),
          (r.PAYMENT_SYSTEM = l.paymentSystem),
          (r.TIMER = l.timer),
          (r.BOOKING_VALID = !1),
          (r.AGREEMENT_DIALOGS = [!1, !1]),
          (r.SELECTED_BASKET_PASSENGER_ID = null),
          (r.SELECTED_DIRECTION = null),
          (r.PERSONAL_NAV = f.personal_navigation),
          (r.USER_INFO = f.user_info),
          (r.CURRENT_OFFERS = f.current_offers),
          (r.HISTORY_OFFER = f.history_offers),
          (r.ALL_STATUS = f.all_status),
          (r.PASSENGER_LIST = f.passenger_list),
          (r.SHOW_MOBILE_BASKET_IN_OFFERS = !1),
          (r.SHOW_MOBILE_FILTER_IN_OFFERS = !1),
          (r.SHOW_MOBILE_BASKET_BOOKING = !1),
          (r.SHOW_MOBILE_BASKET_DETAIL = !1),
          (r.SHOW_MOBILE_PERSONAL_MENU = !1),
          r),
        _ = Object(o.createContext)({ data: "hello" });
      function E(t) {
        var e = t.element;
        ...
        return (
          ...
          [
            ...
            function (t, e) {
              ...
              for (var E = 0, b = 0, S = []; b < p.length; ) {
                y.lastIndex = h ? b : 0;
                var O,
                  w = u(y, h ? p : p.slice(b));
                if (
                  null === w ||
                  (O = f(c(y.lastIndex + (h ? 0 : b)), p.length)) === E
                )
                  b = a(p, b, v);
                else {
                  if ((S.push(p.slice(E, b)), S.length === _)) return S;
                  for (var x = 1; x <= w.length - 1; x++)
                    if ((S.push(w[x]), S.length === _)) return S;
                  b = E = O;
                }
              }
      ...
      ((e = t.exports = function (t, e, n, f, p) {
        ...
        if (i(g)) {
          for (d = c(t.length); d > _; _++)
            if ((v = e ? y(a((h = t[_]))[0], h[1]) : y(t[_])) === s || v === l)
              return v;
        } else
      ...
      Object(p.setLoader)(M),
        ...
        Object(r.apiRunnerAsync)("onClientEntry").then(function () {
          ...
          a &&
            "" + a !== l.pathname &&
            !(
              M.findMatchPath(Object(L.a)(l.pathname, "")) ||
              "/404.html" === a ||
              a.match(/^\/404\/?$/) ||
    ...
    YwZP: function (t, e, n) {
      ...
      var b = function (t) {
        ...
        O = function (t) {
          return o.a.createElement(S.Consumer, null, function (e) {
            return o.a.createElement(_, null, function (n) {
              return o.a.createElement(w, p({}, e, n, t));
            });
          });
        },
        w = (function (t) {
            ...
            (e.prototype.render = function () {
              ...
              if (m) {
                ...
                var E = p({}, v, {
                  ...
                  w = i ? T : u,
                  x = i ? p({ uri: g, location: e, component: u }, s) : s;
                return o.a.createElement(
                  S.Provider,
                  { value: { baseuri: g, basepath: r } },
                  o.a.createElement(w, x, b)
                );
              }
              return null;
            }),
      ...
      var L = j(function (t, e) {
        ...
        return o.a.createElement(S.Consumer, null, function (t) {
          t.basepath;
          var i = t.baseuri;
          return o.a.createElement(_, null, function (t) {
            var a = t.location,
              c = t.navigate,
              u = r.to,
              s = r.state,
      ...
      var M = function (t) {
        ...
        D = function (t) {
          return o.a.createElement(S.Consumer, null, function (e) {
            var n = e.baseuri;
            return o.a.createElement(_, null, function (e) {
          ...
          return x(o).then(function (n) {
            ...
            return 404 === o || 200 === o
              ? "/404.html" === e
                ...
                : T(Object.assign(t, { pagePath: "/404.html", notFound: !0 }))
              : 500 === o
              ? Object.assign(t, { status: S.Error })
              : r < 3
              ? T(Object.assign(t, { retries: r + 1 }))
              : Object.assign(t, { status: S.Error });
          });
        },
        P = function (t, e) {
        ...
        R = (function () {
          ...
          return (
            ...
            (e.getResourceURLsForPathname = function (t) {
              ...
              if (n) {
                var r = P(n.payload);
                return [].concat(_(A(r.page.componentChunkName)), [w(e)]);
              }
              return null;
            }),
    ...
    ioFf: function (t, e, n) {
      ...
      var r = n("dyZX"),
        ...
        z = function (t) {
          ...
          return (
            !(this === B && o(K, t) && !o(q, t)) &&
            (!(e || !o(this, t) || !o(K, t) || (o(this, F) && this[F][t])) || e)
          );
        },
        Q = function (t, e) {
          if (((t = b(t)), (e = S(e, !0)), t !== B || !o(K, e) || o(q, e))) {
            var n = k(t, e);
            return (
              !n || !o(K, e) || (o(t, F) && t[F][e]) || (n.enumerable = !0), n
            );
          }
        },
        $ = function (t) {
          for (var e, n = L(b(t)), r = [], i = 0; n.length > i; )
            o(K, (e = n[i++])) || e == F || e == u || r.push(e);
          return r;
        },
        tt = function (t) {
          for (
            var e, n = t === B, r = L(n ? q : b(t)), i = [], a = 0;
            r.length > a;
      ...
      G ||
        (c(
          (I = function () {
            ...
            return i && V && X(B, t, { configurable: !0, set: e }), H(t);
          }).prototype,
          "toString",
          function () {
            return this._k;
        ...
        (n("UqcF").f = z),
        (P.f = tt),
        i && !n("LQAc") && c(B, "propertyIsEnumerable", z, !0),
        (h.f = function (t) {
          return H(d(t));
        })),
      ...
      for (
        ...
        d(et[nt++]);
      for (var rt = A(d.store), ot = 0; rt.length > ot; ) m(rt[ot++]);
      a(a.S + a.F * !G, "Symbol", {
        for: function (t) {
    ...
    pCP8: function (t, e, n) {
      e.components = {
        ...
        "component---src-templates-index-jsx": function () {
          return n.e(22).then(n.bind(null, "wMyX"));
        },
      };
    },
    pIFo: function (t, e, n) {
        ...
        return [
          ...
          function (t, e) {
            ...
            for (var y = []; ; ) {
              ...
              if (null === _) break;
              if ((y.push(_), !v)) break;
              "" === String(_[0]) && (f.lastIndex = c(p, i(f.lastIndex), g));
            }
            for (var E, b = "", S = 0, O = 0; O < y.length; O++) {
              _ = y[O];
              for (
                var w = String(_[0]),
                  x = s(l(a(_.index), p.length), 0),
                  T = [],
                  P = 1;
                P < _.length;
                P++
              )
                T.push(void 0 === (E = _[P]) ? E : String(E));
              var R = _.groups;
              if (d) {
                var A = [w].concat(T, x, p);
                void 0 !== R && A.push(R);
                var k = String(e.apply(void 0, A));
              } else k = m(w, p, x, T, R, e);
              x >= S && ((b += p.slice(S, x) + k), (S = x + w.length));
            }
            return b + p.slice(S);
          },
        ];
    ...
    rGqo: function (t, e, n) {
      for (
        ...
        var v,
          ...
          _ = a[g],
          E = _ && _.prototype;
        if (E && (E[l] || c(E, l, p), E[f] || c(E, f, g), (u[g] = p), y))
          for (v in r) E[v] || i(E, v, r[v], !0);
      }
    },
    rvZc: function (t, e, n) {
      "use strict";
...
//# sourceMappingURL=app-6c193da25d829ea12295.js.map
