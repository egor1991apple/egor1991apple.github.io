(window.webpackJsonp = window.webpackJsonp || []).push([
  [3],
  {
    ...
    L12J: function (e, t, n) {
      ...
      function Xe(e) {
        ...
        return i.a.createElement(
          ...
          i.a.createElement(
            qe.a.Group,
            { controlId: "formAuth" },
            i.a.createElement(qe.a.Label, null, Ze[n].email.label),
            i.a.createElement(qe.a.Control, {
              required: !0,
              type: "email",
              placeholder: Ze.ru.email.placeholder,
            }),
            i.a.createElement(
              qe.a.Text,
          ...
          i.a.createElement(
            ...
            i.a.createElement(qe.a.Label, null, Ze[n].password.label),
            i.a.createElement(qe.a.Control, {
              required: !0,
              type: "password",
              placeholder: Ze.ru.password.placeholder,
            })
          ),
          i.a.createElement(
            qe.a.Row,
      ...
      function et(e) {
        ...
        return i.a.createElement(
          ...
          i.a.createElement(
            qe.a.Group,
            { controlId: "RegForm" },
            i.a.createElement(qe.a.Label, null, $e[n].email.label),
            i.a.createElement(qe.a.Control, {
              type: "email",
              placeholder: $e.ru.email.placeholder,
            }),
            i.a.createElement(
              qe.a.Text,
          ...
          i.a.createElement(
            qe.a.Group,
            { controlId: "formBasicPassword" },
            i.a.createElement(qe.a.Label, null, $e[n].password.label),
            i.a.createElement(qe.a.Control, {
              required: !0,
              type: "password",
              placeholder: $e.ru.password.placeholder,
            })
          ),
          i.a.createElement(
            C.a,
                      ...
                      i.a.createElement(
                        ...
                        i.a.createElement(
                          ...
                          i.a.createElement(
                            ...
                            i.a.createElement(Xe, { language: c })
                          ),
                          i.a.createElement(
                            Qe.a.Pane,
                            { eventKey: "reg", title: "Регистрация" },
                            i.a.createElement(et, { language: c })
                          )
                        )
                      )
                    )
      ...
      var ot =
        (((tt = {}).IS_AUTH = !1),
        (tt.OPEN_AUTH_DIALOG = !1),
        (tt.SHOW_MOBILE_NAV = !1),
        (tt.SHOW_PLACEMENT_DIALOG = !1),
        (tt.MAIN_SLIDER_SLIDS = rt.main_slider),
        (tt.OFFERS = rt.offers),
        (tt.ROUTES = {
          data: rt.routes,
          nowShowRoutes: 6,
          allCountRoutes: rt.routes.length,
        }),
        (tt.ROUTE_DETAIL = rt.route_detail),
        (tt.ROUTE_SERVISES = rt.route_servises),
        (tt.MAIN_WHY_WE_ARE = rt.main_why_we_are),
        (tt.MAIN_QUESTION_ANSWER = rt.main_question_answer),
        (tt.MAIN_NEWS = rt.news),
        (tt.SERVISES = rt.servises),
        (tt.SOCIAL = rt.social),
        (tt.PAYMENT = rt.payment),
        (tt.CONTACT = rt.contact),
        (tt.TOP_NAVS = rt.main_navs_list),
        (tt.BUS = rt.busPlacement),
        (tt.BASKET = { 0: [], 1: [] }),
        (tt.BASKET_COMMIT = []),
        (tt.SELECTED_OFFERS_ID = 0),
        tt);
      t.a = function (e) {
        var t = e.children;
        e.pageInfo;
...
//# sourceMappingURL=commons-1609d233e63cc0f99475.js.map
