  ...
  [9],
  {
    ...
    GddB: function (t, e, n) {
      ...
      var r,
        ...
        l = function (t, e) {
          ...
          switch ((console.log(t, r), r)) {
            ...
            case s.H:
              return Object.assign({}, t, { SHOW_MOBILE_NAV: !t[s.H] });
            case s.m:
            ...
            case s.C:
              return Object.assign({}, t, {
                SHOW_PAYMENT_SYTEM_DIALOG: !t[s.C],
              });
            case s.y:
            ...
            value: Object.assign({}, r, {
              ...
              onSelectPaymentSystem: function (t) {
                ...
                e.forEach(function (n, r) {
                  ...
                  a({ type: s.y, payload: e });
              },
              onClearBasket: function () {
                a({ type: s.h, payload: [] }), Object(p.navigate)("/offers");
              },
              onBooking: m,
              onToggleAgreementDialog: function (t) {
                return function () {
                  var e = r.AGREEMENT_DIALOGS;
                  (e[t] = !e[t]), console.log(e), a({ type: s.F, payload: e });
                };
              },
              lang: "ru",
            }),
      ...
      var g =
          ...
          (r[s.v] = f.route_detail),
          (r[s.w] = f.route_servises),
          ...
          [
            ...
            function (t, e) {
              ...
              for (var w = 0, x = 0, S = []; x < p.length; ) {
                ...
                if (
                  null === E ||
                  (_ = f(u(y.lastIndex + (h ? 0 : x)), p.length)) === w
                )
                  x = a(p, x, m);
                else {
        ...
        a = function (t, e) {
          for (
            ...
            if (h.default) r = { route: h, params: {}, uri: e };
              ...
              if (!p) {
                n = { route: h, params: b, uri: "/" + a.slice(0, x).join("/") };
                break;
              }
            }
          }
    ...
    ioFf: function (t, e, n) {
      ...
      var r = n("dyZX"),
        ...
        z = function (t) {
          ...
          return (
            !(this === W && o(N, t) && !o(K, t)) &&
            (!(e || !o(this, t) || !o(N, t) || (o(this, U) && this[U][t])) || e)
          );
        },
        Q = function (t, e) {
          if (((t = x(t)), (e = S(e, !0)), t !== W || !o(N, e) || o(K, e))) {
            var n = A(t, e);
            return (
              !n || !o(N, e) || (o(t, U) && t[U][e]) || (n.enumerable = !0), n
            );
          }
        },
        $ = function (t) {
          for (var e, n = L(x(t)), r = [], i = 0; n.length > i; )
            o(N, (e = n[i++])) || e == U || e == c || r.push(e);
          return r;
        },
        tt = function (t) {
          for (
            var e, n = t === W, r = L(n ? K : x(t)), i = [], a = 0;
            r.length > a;
      ...
      G ||
        (u(
          (C = function () {
            ...
            return i && X && Y(W, t, { configurable: !0, set: e }), B(t);
          }).prototype,
          "toString",
          function () {
            return this._k;
      ...
      a(a.S + a.F * it, "Object", {
        ...
        C.prototype[D] || n("Mukb")(C.prototype, D, C.prototype.valueOf),
        f(C, "Symbol"),
        f(Math, "Math", !0),
        f(r.JSON, "JSON", !0);
    },
          ...
          function (t, e) {
            ...
            for (var w, x = "", S = 0, _ = 0; _ < y.length; _++) {
              ...
              for (
                ...
                P.push(void 0 === (w = b[j]) ? w : String(w));
              var R = b.groups;
              if (d) {
                var k = [E].concat(P, O, p);
                void 0 !== R && k.push(R);
                var A = String(e.apply(void 0, k));
              } else A = v(E, p, O, P, R, e);
              O >= S && ((x += p.slice(S, O) + A), (S = O + E.length));
            }
            return x + p.slice(S);
          },
        ];
...
//# sourceMappingURL=app-972bab0edca505545196.js.map
